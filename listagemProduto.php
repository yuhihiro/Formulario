        ...
        <table class="table">
            ...
            ?>
                <tr>
                    ...
                    <td><a class="btn btn-primary" style="text-decoration: none;" href="editarProduto.php?id=<?php echo $idProduto ?>" role="button">Editar</a>
                        <a class="btn btn-primary" href="deletarProduto.php?id=<?php echo $idProduto ?>">Excluir</a>
                    </td>
                </tr>
            <?php } ?>
        </table>
