<?php
    ...
    $sql = "INSERT INTO `produtos`(`numeroProduto`, `nomeProduto`, `qtdProduto`, `catProduto`, `fornProduto`)  VALUES ($numeroProduto,'$nomeProduto',$qtdProduto,'$catProduto','$fornProduto')";
